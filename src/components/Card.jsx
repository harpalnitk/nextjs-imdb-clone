...
// group lets apply css class to parent when hover is on child
//in this case even when we hover on card the image is made opacity:0.8
  ...
  return (
    <div className='cursor-pointer sm:p-3 sm:hover:shadow-slate-400 sm:shadow-md rounded-lg sm:border sm:border-slate-400 sm:m-2 transition-shadow duration-200 group'>
     ...
     <Image
        ...
        ></Image>
        <div className='p-2'>
            {/* truncate limits to only one line  */}
